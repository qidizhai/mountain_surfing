...
House.create!(
  description: 'Yosemite gateway chalet',
  lat: 37.7636023,
  lng: -119.1085565,
...
House.create!(
  description: 'Yosemite Forest Lodge',
  lat: 37.6423375,
  lng: -119.0034716,
...
House.create!(
  description: 'Little Ahwahnee Inn',
  lat: 37.4775974,
  lng: -119.6387045,
...
House.create!(
  description: 'Rainbow Lodge Remodel',
  lat: 44.4182434,
  lng: -110.5803911,
...
House.create!(
  description: 'Brokoks Lake Lodge',
  lat: 44.5015582,
  lng: -110.0193159,
...
House.create!(
  description: 'Edoctorradio cabin',
  lat: 35.5194197,
  lng: -83.3222574,
...
House.create!(
  description: 'Inspirational cabin',
  lat: 35.5200135,
  lng: -83.2957787,
...
House.create!(
  description: 'Ranch View village',
  lat: 43.6579927,
  lng: -110.7616835,
...
House.create!(
  description: 'Everest view villa',
  lat: 27.918084,
  lng: 86.6575695,
...
House.create!(
  description: 'Boulder Crest villa',
  lat: 33.6538736,
  lng: -111.8699052,
...
House.create!(
  description: 'Rifugio Duca degli Abruzzi',
  lat: 45.963972,
  lng: 7.6432169,
